...
"[project]/src/app/CardSwap.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AlbumCarousel = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AlbumCarousel.useEffect": ()=>{
            var _nextRef_current, _prevRef_current;
            ...
            SHIFTS.forEach({
                "AlbumCarousel.useEffect": (BOX, index)=>{
            ...
            const TRIGGER = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create({
                ...
                pin: '.boxes',
                onUpdate: {
                    "AlbumCarousel.useEffect.TRIGGER": (self)=>{
                ...
                }["AlbumCarousel.useEffect.TRIGGER"]
            });
            const WRAP = {
                "AlbumCarousel.useEffect.WRAP": (iterationDelta, scrollTo)=>{
                    iteration += iterationDelta;
                    TRIGGER.scroll(scrollTo);
                    TRIGGER.update();
                }
            }["AlbumCarousel.useEffect.WRAP"];
            const SNAP = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.snap(1 / BOXES.length);
            const progressToScroll = {
                "AlbumCarousel.useEffect.progressToScroll": (progress)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.clamp(1, TRIGGER.end - 1, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.wrap(0, 1, progress) * TRIGGER.end)
            }["AlbumCarousel.useEffect.progressToScroll"];
            const scrollToPosition = {
                "AlbumCarousel.useEffect.scrollToPosition": (position)=>{
            ...
            }["AlbumCarousel.useEffect.scrollToPosition"];
            const NEXT = {
                "AlbumCarousel.useEffect.NEXT": ()=>scrollToPosition(SCRUB.vars.position - 1 / BOXES.length)
            }["AlbumCarousel.useEffect.NEXT"];
            const PREV = {
                "AlbumCarousel.useEffect.PREV": ()=>scrollToPosition(SCRUB.vars.position + 1 / BOXES.length)
            }["AlbumCarousel.useEffect.PREV"];
            document.addEventListener('keydown', {
                "AlbumCarousel.useEffect": (event)=>{
                    if (event.code === 'ArrowLeft' || event.code === 'KeyA') NEXT();
                    if (event.code === 'ArrowRight' || event.code === 'KeyD') PREV();
                }
            }["AlbumCarousel.useEffect"]);
            const boxContainer = boxesRef.current;
            boxContainer === null || boxContainer === void 0 ? void 0 : boxContainer.addEventListener('click', {
                "AlbumCarousel.useEffect": (e)=>{
                    const BOX = e.target.closest('.box');
                    if (BOX) {
                        let TARGET = BOXES.indexOf(BOX);
                        let CURRENT = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.wrap(0, BOXES.length, Math.floor(BOXES.length * SCRUB.vars.position));
            ...
            (_nextRef_current = nextRef.current) === null || _nextRef_current === void 0 ? void 0 : _nextRef_current.addEventListener('click', NEXT);
            (_prevRef_current = prevRef.current) === null || _prevRef_current === void 0 ? void 0 : _prevRef_current.addEventListener('click', PREV);
            return ({
                "AlbumCarousel.useEffect": ()=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getAll().forEach({
                        "AlbumCarousel.useEffect": (st)=>st.kill()
                    }["AlbumCarousel.useEffect"]);
                }
            })["AlbumCarousel.useEffect"];
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            COVERS.map((cover, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "box",
                    style: {
                        position: 'absolute',
                        top: '50%',
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                        ...
                        fileName: "[project]/src/app/CardSwap.tsx",
                        lineNumber: 174,
                        columnNumber: 11
...
_s(AlbumCarousel, "AyBCqFNrv22f6LOZVNhCxFAs3K4=");
_c = AlbumCarousel;
const __TURBOPACK__default__export__ = AlbumCarousel;
var _c;
__turbopack_context__.k.register(_c, "AlbumCarousel");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_app_223d9c95._.js.map